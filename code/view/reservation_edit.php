  ...
  <script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script> -->
    ...
    <body>
        ...
        <div class="container text-white mt-3">
            ...
            <form action ="<?php echo BASEURL.'reservation_controller/edit_reservation/'.$data2?>" method="post">
...
<input type="text" class = "form-control" id="dt" name = "prad" />
</div>
<div class="form-group">
 <label for="pabaiga">Pabaiga</label>
<input type ="text" class = "form-control" id="dt2" name = "pab" />
</div>
