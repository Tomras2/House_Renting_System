...
<html>
    ...
    <body>
        ...
        <div class="container text-white mt-3">
            <h1>Keisti skelbimą</h1>
            
            <form action="<?php echo BASEURL,'listing_controller/editListing/'.$data["lid"]; ?>" method="POST">
                ...
                <button class="btn btn-primary" type="submit">Keisti skelbimą</button>
            </form>
